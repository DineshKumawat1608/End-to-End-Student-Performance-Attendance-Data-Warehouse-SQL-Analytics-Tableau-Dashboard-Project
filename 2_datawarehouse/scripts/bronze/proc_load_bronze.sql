...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM 'D:\Projects\SQL_P1_Student_Performance_and_Attendance\Dataset\Student Performance and Attendance Dataset\attendance.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'D:\Projects\SQL_P1_Student_Performance_and_Attendance\Dataset\Student Performance and Attendance Dataset\homework.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            ROWTERMINATOR = '0x0a',
        ...
        FROM 'D:\Projects\SQL_P1_Student_Performance_and_Attendance\Dataset\Student Performance and Attendance Dataset\performance.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'D:\Projects\SQL_P1_Student_Performance_and_Attendance\Dataset\Student Performance and Attendance Dataset\students.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            ROWTERMINATOR = '0x0a',
        ...
        FROM 'D:\Projects\SQL_P1_Student_Performance_and_Attendance\Dataset\Student Performance and Attendance Dataset\teacher_parent_communication.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            ROWTERMINATOR = '0x0a',
